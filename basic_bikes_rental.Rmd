...
```{r}
head(train_bikes$num_bikes)
```

```{r}
predict(model_rf_reg, newdata = head(train_bikes))

plot(x=predict(model_rf_reg), y= train_bikes$num_bikes,
...
```{r}
predict(model_xgbTree, newdata = head(train_bikes))

plot(x=predict(model_xgbTree), y= train_bikes$num_bikes,
     xlab='Predicted Values',
     ylab='Actual Values',
     main='Predicted vs. Actual Values')
abline(a = 0, b = 1, col = "red", lwd = 2)
...
```{r}
predict(model_xgbTree2, newdata = head(train_bikes))

plot(x=predict(model_xgbTree2), y= train_bikes$num_bikes,
     xlab='Predicted Values',
     ylab='Actual Values',
     main='Predicted vs. Actual Values')
abline(a = 0, b = 1, col = "red", lwd = 2)
...
```{r}
predict(model_xgbTree3, newdata = head(train_bikes))

plot(x=predict(model_xgbTree3), y= train_bikes$num_bikes,
     xlab='Predicted Values',
     ylab='Actual Values',
     main='Predicted vs. Actual Values')
abline(a = 0, b = 1, col = "red", lwd = 2)
...
```{r}
predict(model_glmnet_reg, newdata = head(train_bikes))

plot(x=predict(model_glmnet_reg), y= train_bikes$num_bikes,
     xlab='Predicted Values',
     ylab='Actual Values',
     main='Predicted vs. Actual Values')
abline(a = 0, b = 1, col = "red", lwd = 2)
