...
Una de las librerías más populares de aprendizaje automático, y que ha demostrado una gran eficiencia y escalabilidad es XGBoost. El paquete Caret incluye entre sus funciones una implementación de la API de XGBoost para R. Se trata del método xgbTree.
