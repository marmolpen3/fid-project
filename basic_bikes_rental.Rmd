...
expected_value[1, 11]
predict(model_rf_reg, sample_1)
```

A través del modelo generado con Random Forest se obtiene una predicción algo más ajustada al caso esperado, indicando 148 bicicletas alquiladas para las 133 esperadas por el caso real.
...
expected_value[1, 11]
predict(model_gbm_reg, sample_1)
```
