...
Respecto a la evaluación de los modelos, tras ejecutar la función *clValid* obtenemos que el algoritmo más adecuado para el dataset elegido es jerárquico con k=2 según la mayoría de métodos evaluados.
