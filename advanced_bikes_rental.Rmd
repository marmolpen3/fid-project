...
Se puede observar la gran correlación existente entre todas las variables, tanto negativa como positiva.

## Clustering

El objetivo de someter a los datos a un estudio de clustering es obtener los países que tienen las mísmas características. Primero, nos aseguramos de que todas las variables con las que trabajamos son de clase numérica.
...
En este caso, observamos en la altura 6-8 tres agrupaciones de datos que son similares entre sí.

```{r}

plot(hier_clust_c_complete, cex = 0.6, hang = -1)
rect.hclust(hier_clust_c_complete, k = 3, border = 2:4)
...
```{r}
plot(hier_clust_c_single, cex = 0.6, hang = -1)
rect.hclust(hier_clust_c_single, k = 3, border = 2:4)
```
